...
{{--
    ...
    A superficie escura com a grade da marca, o selo do assunto, o titulo e o
    icone da pagina. Repetido em nove paginas: escrito a mao em cada uma, o
    espacamento do titulo ja tinha saido diferente em duas delas.

    A altura e a mesma em todas, e de proposito. Faixa que encolhe conforme o
    tamanho do titulo faz o cabecalho pular de lugar a cada troca de pagina, e
    quem navega entre elas sente o site inteiro balancar.
--}}

<section class="superficie-escura grade-viva-escura relative overflow-hidden lg:h-[210px]">
    ...
    <div class="mx-auto flex h-full w-full max-w-[87rem] items-center gap-8 px-6 py-12 lg:py-0">
        ...
        {{-- O icone da pagina, na moldura rosa que acompanha a luz do canto.
             Escondido no celular: ali a largura e do titulo, e um simbolo
             decorativo roubando meia linha dele nao paga o espaco. --}}
        @if ($icone)
    ...
    {{-- A linha no pe da faixa, com o pulso atravessando: o mesmo movimento do
         diagrama do herói, que e o que amarra as paginas a porta do dominio. --}}
