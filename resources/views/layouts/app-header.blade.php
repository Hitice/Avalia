<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            {{-- A busca do template era decorativa: sem action, sem handler.
                 Volta quando houver o que buscar (cliente, consulta, fatura). --}}
        </div>
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <div class="flex items-center gap-2 2xsm:gap-3">
                ...
                {{-- Sino removido junto com a busca: nao ha evento real para
                     notificar ainda. Sino que nunca acende ensina a ignorar sino. --}}
            </div>
