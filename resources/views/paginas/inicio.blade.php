...
@section('content')
    <div class="min-h-screen bg-white text-gray-800 dark:bg-gray-900 dark:text-white/90"
        ...
        <a href="{{ Suporte::whatsapp('Quero conhecer a Avalia') }}" target="_blank" rel="noopener noreferrer"
           ...
           class="fixed right-4 bottom-5 z-40 flex size-11 items-center justify-center rounded-full bg-success-500 text-white shadow-theme-lg transition hover:scale-110 hover:bg-success-600">
        ...
        <footer class="border-t border-gray-100 dark:border-gray-800">
            <div class="mx-auto flex w-full max-w-[87rem] flex-wrap items-center justify-between gap-4 px-6 py-8 text-sm text-gray-500 dark:text-gray-400">
                ...
                <p class="text-center">
                    © {{ now()->year }} Avalia · CNPJ 39.914.870/0001-01<br>
                    <span class="text-xs">Consultas com finalidade declarada e trilha de auditoria.</span>
                </p>
                <div class="flex items-center gap-5">
                    <a class="hover:text-brand-500" href="{{ route('entrar') }}">Entrar</a>
                    <a class="hover:text-brand-500" href="mailto:comercial@avaliaone.com.br">comercial@avaliaone.com.br</a>
                </div>
            </div>
        </footer>
