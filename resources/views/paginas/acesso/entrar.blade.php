    ...
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900"
        ...
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <x-avalia.senha id="senha" name="senha" required
                                                ...
                                                classe="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                            </div>
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center justify-center overflow-hidden lg:flex lg:w-3/5"
                ...
                {{-- placa-viva: 15% maior via scale (proporcoes intactas),
